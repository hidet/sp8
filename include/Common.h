...
// World (Vacuum)
const G4double world_size[3] = {2.0*m,2.0*m,5.0*m};
// Air
...
// target calibration foils
const G4double target_z    = 702.8*mm;// 16.-3.+3.9+400+3.9+282
const G4double target_thickness = 0.1*mm;// Pb
const G4double target_size[3]={90.*mm, 110.*mm, target_thickness};
const G4double target_pos[3]={0., 0., ff_posz};
//// target (Ne gas)
//const G4double target_z    = 702.8*mm;// 16.-3.+3.9+400+3.9+282
...
const G4double snout300kwnd_z    = 0.3*mm;// 300um Be
...
const G4double snout300k_pos[3]={adr_posx,0.,ff_posz};
...
// SDD Si
const G4double sdd_size[3] = {10.*mm,10.*mm,0.500*mm};
...
const G4double sddwnd_z    = 0.0125*mm;// Be 12.5 um
